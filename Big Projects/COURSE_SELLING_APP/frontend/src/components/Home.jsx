      ...
      <div className='text-white container mx-auto'>
        ...
        <section className='text-center mt-8'>
          ...
          <div className='space-x-4 mt-4'>
            ...
            <Link to={"https://www.youtube.com/c/LearnCodingOfficial"} className='bg-white text-black rounded font-semibold hover:text-white duration-300 hover:bg-green-500 px-5 py-2'>Courses Videos</Link>
          </div>
        </section>
